...
u6 = User.create(name: "渡辺", password: "3016", mail: "7657@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u7 = User.create(name: "吉田", password: "0465", mail: "9673@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u8 = User.create(name: "久保", password: "5039", mail: "5719@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u9 = User.create(name: "中村", password: "0647", mail: "2047@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u10 = User.create(name: "権田", password: "7020", mail: "4640@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u11 = User.create(name: "前田", password: "0895", mail: "3045@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u12 = User.create(name: "遠藤", password: "9031", mail: "3758@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u13 = User.create(name: "安田", password: "1065", mail: "0489@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u14 = User.create(name: "山本", password: "1135", mail: "2053@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u15 = User.create(name: "加藤", password: "1223", mail: "8905@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u16 = User.create(name: "石川", password: "1353", mail: "2937@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u17 = User.create(name: "橋本", password: "1421", mail: "2356@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u18 = User.create(name: "木村", password: "1547", mail: "3958@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
u19 = User.create(name: "川村", password: "1637", mail: "9385@xxxx", address:"出雲市", manage_flag: false, stop_flag:false )
# 管理者
...
p15 = Product.create(name: "出雲工業の男子制服",  price:2200, explanation: "出雲工業の男子制服です", user_id: u1.id, product_class_id: pc1.id, image: "sample2.png", sale: "販売中")
